...
import java.util.Scanner;
    ...
    public class Main {
        ...
        public static void main(String args[]) throws IOException, ClassNotFoundException {
            ...
            Integer contador = 0;
            Integer opcion = null;
            ArrayList<Jugador> personas = unArchivo.cargarDatos(new Scanner(new File("C:\\Users\\aa8vhzz\\IdeaProjects\\Simulacion2.SistemasOperativos\\src\\com\\company\\players_15.csv")));
            System.out.println("(Tamaño ArrayList--> " + personas.size()+")\n");
        ...
        public static ArrayList<Jugador> leerDatos() throws IOException, ClassNotFoundException {
            FileInputStream fi = new FileInputStream(new File("C:\\Users\\aa8vhzz\\IdeaProjects\\Simulacion2.SistemasOperativos\\src\\com\\company\\archivo.dat"));
        ...
        public static void guardarDatos(ArrayList<Jugador> personas) throws IOException {
            FileOutputStream f = new FileOutputStream(new File("C:\\Users\\aa8vhzz\\IdeaProjects\\Simulacion2.SistemasOperativos\\src\\com\\company\\archivo.dat"));
